...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Online Education Application`}</title>

        <meta
          name="description"
          content="Online Education Application - Learn at your convenience from the world's best faculty members. Join our network of 500+ hiring partners."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlZHVjYXRpb258ZW58MHx8fHwxNjk3MjAxMTU4fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Online Education Application - Learn at your convenience from the world's best faculty members. Join our network of 500+ hiring partners.`}
            </Text>
            <Box
