...
import { useRoqClient, useUniversityFindManyWithCount } from 'lib/roq';
...
export function UniversityListPage(props: UniversityListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useUniversityFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.university.delete({ where: { id } });
      await mutate();
    } catch (error) {
